...
const About: React.FC = () => {
  ...
  const memberParagraph =
    language === 'EN'
      ? 'By becoming a member of FFLO Story Space for just $30/month, you gain exclusive access to reserve up to four French books per month, one at a time, for a one-week period. Members can conveniently browse and reserve books online, then pick them up and return them to our FFLO campus. Membership not only unlocks our entire collection of French literature but also welcomes you into a vibrant French-speaking community in NYC, where families can share in their passion for French language and culture.'
      : "En devenant membre de l’Espace Lecture FFLO pour seulement 30 $ par mois, vous bénéficiez d’un accès exclusif pour réserver jusqu’à quatre livres en français par mois, un à la fois, pour une période d'une semaine. Les membres peuvent facilement parcourir et réserver des livres en ligne, puis venir les retirer et les retourner sur notre campus FFLO. L’abonnement vous permet non seulement de profiter de notre collection complète de littérature française, mais aussi de rejoindre une communauté francophone dynamique à New York, où les familles partagent leur passion pour la langue et la culture françaises.";
